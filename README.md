...
## Important Note
This project was created as an example use case of ButterCMS in conjunction with a blog article, [How to Create Engaging Django Landing Pages with ButterCMS](https://buttercms.com/blog/create-django-landing-page-tutorial/), and will not be actively maintained.
